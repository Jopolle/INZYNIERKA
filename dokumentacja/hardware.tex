...
Tor wejściowy odpowiada za obsługę czujników przemysłowych (pasywnych i aktywnych) oraz bezpieczne doprowadzenie sygnałów 0--10~V do wielokanałowego przetwornika A/C ADS8688\cite{TI_ADS8688}. Schemat tej części układu przedstawiono na rysunku~\ref{fig:schemat-mcu}. Przetwornik ten integruje w sobie przełączany multiplekser wejściowy, programowalne zakresy napięciowe oraz wewnętrzny front-end zabezpieczający, co pozwala uprościć zewnętrzny tor analogowy.
