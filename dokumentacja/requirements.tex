...
Zanim przejdzie się do szczegółów dotyczących sprzętu i oprogramowania, warto jednoznacznie
określić, czego właściwie oczekuje się od projektowanego stanowiska. Wymagania mają tutaj dwa
...
\begin{itemize} 
  ...
  \item Do dyspozycji użytkownika powinno być co najmniej osiem wejść i osiem wyjść
        ...
        wykonawczych oraz odtworzyć uproszczony schemat małej centrali wentylacyjnej.
  \item Każdy kanał wejściowy ma udostępniać, oprócz samego sygnału, także dedykowaną masę
        ...
        czujników przemysłowych bez dodatkowych zasilaczy pomocniczych.
  ...
  \item Oprogramowanie powinno realizować co najmniej jedną pętlę regulacji temperatury (regulator PI/PID w zależności od wybranej konfiguracji) z wyjściem wyrażonym w procentach, które są następnie rozdzielane
        na wyjścia odpowiadające grzałce, chłodnicy, odzyskowi ciepła i wentylatorowi
...
Spełnienie powyższych punktów oznacza, że stanowisko może zostać wykorzystane jako prosty,
ale dość elastyczny w dalszym rozwoju układ labolatoryjny, pozwalające zarówno na pomiary statyczne, jak i na
